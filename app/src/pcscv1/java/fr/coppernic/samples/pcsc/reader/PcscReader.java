...
/**
 * PSC/SC reader V1 is suitable for all devices like Device HMD ou OS Coppernic before OS `20240813`.
 * Pcsc v1 is NOT dependant of CoreService and can be run on HMD devices.
 */
public class PcscReader {
     ...
     */
    public ApduResponse sendApdu(byte [] apdu) throws CpcResult.ResultException {
